...
public class EqualsDiff {
    public static void main(String[] args) {
        ...
        System.out.println("str1.equals(strobj1): "+(str1.equals(strobj1)));//true
        ...
        System.out.println("strobj1.equals(strobj3): "+(strobj1.equals(strobj3)));//false
        System.out.println("strobj1 != strobj3: "+(strobj1 != strobj3));//true
    }
}